...
from borrowing_transaction import BorrowingTransaction  # Import BorrowingTransaction class
from book_search import BookSearch   # Import BookSearch
...
api.add_resource(Borrower, "/borrowers", "/borrowers/<int:borrower_id>")
api.add_resource(BorrowingTransaction, "/transactions", "/transactions/<int:transaction_id>")  # Add BorrowingTransaction endpoints
api.add_resource(BookSearch, "/books/search")  # Add BookSearch endpoint
